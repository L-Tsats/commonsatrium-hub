...
export default function MembershipSuccessPage() {
  return (
    <main className="min-h-screen px-6 py-10">
      <div className="page-card mx-auto max-w-2xl rounded-2xl bg-white p-8 shadow-lg md:p-12 text-center">
        ...
        <div className="mt-8">
          <Link href="/dashboard" className="inline-flex rounded-xl bg-black px-5 py-3 text-sm font-medium text-white hover:opacity-90">
            Go to Dashboard
          </Link>
        </div>
      </div>
